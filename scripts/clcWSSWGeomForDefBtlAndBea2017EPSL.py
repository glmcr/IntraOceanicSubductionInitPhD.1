...
#    },
    ...
    "oceanicUppCrust": {
        ...
        "TCeil2Floor": [ [ nbYPtsF, surfT ], [OUCFloor, OUCFloorT]],
        "polygons": [
              # 1st WZ triangle at right of the CUC
              [
                [contVsOcean+SCLMThkn+CLCThkn,OUCFloor],
                [contVsOcean+SCLMThkn+CLCThkn+CUCThkn,CUCCeil],
                [contVsOcean+SCLMThkn+CLCThkn+CUCThkn,OUCFloor]
              ],
              # Rectangle for the rest of the oceanic crust
              [
                [contVsOcean+SCLMThkn+CLCThkn+CUCThkn,OUCFloor],
                [contVsOcean+SCLMThkn+CLCThkn+CUCThkn,OUCCeil],
        ...
        "polygons":
           [
             [
               ...
               [contVsOcean+SCLMThkn+CLCThkn, OSDFloor],
               [contVsOcean+SCLMThkn+CLCThkn, OSDCeil],
               [nbXPtsF,OSDCeil],
               [nbXPtsF,OSDFloor]
             ]
           ]
