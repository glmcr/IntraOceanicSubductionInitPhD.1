...
oCrustFloor=693e3
#ocCrustThickness=
oLithThickness= oCrustFloor-oLithFloor
...
composGeomDict= {
    "oceanicCrust": {
        ...
        "polygons":
            [
                [ [0.0,oCrustFloor], [0.0,nbYPtsF], [midXPoint,nbYPtsF], [midXPoint,oCrustFloor] ],
                [ [midXPoint+wzXLen,oCrustFloor], [midXPoint+wzXLen,nbYPtsF], [nbXPtsF,nbYPtsF], [nbXPtsF,oCrustFloor] ]
            ]
    },
   "oceanicLithMantle":  {
        "col": 3,
        "TCeil2Floor": [[oCrustFloor,oCrustFloorT], [oLithFloor, oLithFloorT ]],
        "polygons":
            [
                [ [0.0,oLithFloor], [0.0,oCrustFloor], [midXPoint,oCrustFloor], [midXPoint,oLithFloor] ],
                [ [midXPoint+wzXLen,oCrustFloor], [midXPoint+wzXLen+oLithThickness,oCrustFloor], [midXPoint+wzXLen+oLithThickness,oLithFloor] ],
                [ [midXPoint+wzXLen+oLithThickness,oLithFloor], [midXPoint+wzXLen+oLithThickness,oCrustFloor], [nbXPtsF,oCrustFloor], [nbXPtsF,oLithFloor] ]
            ]
    },
    "asthenosphere": {
        "col": 4,
        "TCeil2Floor": [[oLithFloor, AAUMCeilT], [AAUMFloor, AAUMFloorT]],
        "polygons":
            [
                [ [0.0,AAUMFloor], [0.0,oLithFloor], [nbXPtsF,oLithFloor], [nbXPtsF,AAUMFloor] ]
            ] 
    },
    "weakZone": {
        "col": 5,
        "TCeil2Floor": [[nbYPtsF, surfT], [oLithFloor,oLithFloorT]],
        "polygons":
            [
                [ [midXPoint,oLithFloor], [midXPoint,nbYPtsF], [midXPoint+wzXLen,nbYPtsF], [midXPoint+wzXLen,oLithFloor] ],
                [ [midXPoint+wzXLen,oLithFloor], [midXPoint+wzXLen,oCrustFloor], [midXPoint+wzXLen+oLithThickness,oLithFloor]]
            ]
    },
    "MTZ": {
        "col": 6,
